...
<body>
        ...
        <div class="layout-container">
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="card">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <button type="button" class="btn btn-icon btn-outline-primary me-3 add-petugas-btn"
                    ...
                    <!-- Modal Detail Petugas - Responsive Version -->
                    <div class="modal fade" id="petugasDetailModal" tabindex="-1"
                        aria-labelledby="petugasDetailModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
                            <div class="modal-content">
                                <div class="modal-header bg-primary text-white">
                                    <h5 class="modal-title" id="petugasDetailModalLabel">
                                        <i class="bx bx-user-detail me-2"></i>Detail Petugas
                                    </h5>
                                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
                                <div class="modal-body p-3 p-md-4">
                                    <div id="petugasDetailContent">
                                ...
                                <div class="modal-footer flex-column flex-sm-row gap-2">
                                    ...
                                    <button type="button" class="btn btn-primary w-100 w-sm-auto"
                                        onclick="editPetugas(currentPetugasId)">
                                        <i class="bx bx-edit me-1"></i>Edit Petugas
                                    </button>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- Modal Form Petugas - Responsive Version -->
                    <div class="modal fade" id="petugasFormModal" tabindex="-1" aria-labelledby="petugasFormModalLabel"
                        aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content border-0 shadow-lg">
                                <div class="modal-header bg-gradient text-white"
                                    style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                                    <h5 class="modal-title" id="petugasFormModalLabel">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="email" class="form-control form-control-lg" id="email"
                                                        name="email" required placeholder="petugas@example.com">
    ...
    <script src="controller/PetugasController.js"></script>
